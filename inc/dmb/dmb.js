...
$(document).ready(function (){
  ...
  $('.dmb_show_preview_team').click(function(){
    ...
    preview_html += '<div class="slider--teams equipos" style="margin-top: 100px;">';
      ...
      preview_html += '<ul id="list" class="cf equipos_container">';
        ...
        $('.dmb_main').not('.dmb_empty_row').each(function(i, obj){
          ...
          preview_html += '<div class="equipos_member" style="border-top:' + settings.color + ' solid 5px;">';
            ...
            if (fields.photoLinkUrl)
              ...
              if (fields.photoUrl) {
                preview_html += '<div class="equipos_photo equipos_pic_' + i + '" style="background: url(' + fields.photoUrl + '); margin-left: auto; margin-right:auto; background-size:cover !important;"></div>';
              } else {
                preview_html += '<div class="equipos_photo equipos_pic_' + i + '" style="background: url(../wp-content/plugins/equipos/inc/img/profile.jpg); margin-left: auto; margin-right:auto; background-size:cover !important;"></div>';
              }
            ...
            /* Creates text block. */
            preview_html += '<div class="equipos_textblock">';

              /* Displays names. */
              preview_html += '<div class="equipos_names">';
              if (fields.firstname) {
                preview_html += '<span class="equipos_fname">' + fields.firstname + '</span> ';
              }
              if (fields.lastname) {
                preview_html += '<span class="equipos_lname">' + fields.lastname + '</span>';
              }
              preview_html += '</div>';

              /* Displays jobs. */
              if (fields.job) {
                preview_html += '<div class="equipos_job">' + fields.job + '</div>';
              }

              /* Displays bio. */
              if (fields.bio) {
                preview_html += '<div class="equipos_desc" style="text-align:' + settings.bio_alignment + '">' + fields.bio + '</div>';
              }

              /* Creates social block. */
              preview_html += '<div class="equipos_scblock">';
                ...
                for (var j = 1; j <= 3; j++) {
                  ...
                  if (fields['scl_type' + j] != 'nada') {
                    ...
                    if (fields['scl_type' + j] == 'email') {
                      preview_html += '<a class="equipos_sociallink" href="mailto:' + currentUrl + '" title="' + currentTitle + '"><img alt="' + currentTitle + '" src="../wp-content/plugins/' + pluginFolderSlug + '/inc/img/links/' + fields['scl_type' + j] + '.png"/></a>';
                    } else {
                      preview_html += '<a target="_blank" class="equipos_sociallink" href="' + currentUrl + '" title="' + currentTitle + '"><img alt="' + currentTitle + '" src="../wp-content/plugins/' + pluginFolderSlug + '/inc/img/links/' +fields['scl_type' + j] + '.png"/></a>';
                    }
    ...
    preview_html += '</div>'; // Closes equipos.
  ...
  $('.dmb_preview_team_close').click(function(){
    $('#dmb_preview_team .equipos, .dmb_accuracy_preview_notice, .dmb_no_row_preview_notice').remove();
